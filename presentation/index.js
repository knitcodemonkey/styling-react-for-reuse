  ...
  render() {
    return (
      ...
      {/* <Deck transition={["fade"]} transitionDuration={100} theme={theme}> */}
        ...
        {/* Jen Luker Intro */}
        <Slide notes="Software engineer, professionally, for over 10 years">
          <Layout>
            <Fill>
              <Image margin="0" src={images.me} style={{
                maxWidth: '80%', borderRadius: '50%', boxShadow: "0px 10px" + " 20px #CECECE"
              }} />
            </Fill>
        ...
        <Layout style={{marginTop: -80}}>
            <Fill style={{flex: '1 1 25%', display: 'flex', alignItems: 'center'}}>
              <Image src={images.samuelSmiles} style={{
                width: 500, height: 500, borderRadius: '50%', marginTop: -70, marginRight: 20, boxShadow: "0px 0px" + " 20px #333"
              }} />
            </Fill>
            <Fill style={{flex: '1 1 75%', display: 'flex', alignItems: 'center'}}>
              <BlockQuote>
...
{/* Accessibility Summary Slide */}
          ...
          <Layout style={{marginTop: -120}}>
            <Fill style={{flex: '1 1 25%', display: 'flex', alignItems: 'center'}}>
              <Image src={images.JenniferVan} style={{
                width: 400, height: 400, borderRadius: '50%', marginTop: -70, marginRight: 20, boxShadow: "0px 0px" + " 20px #444"
              }} />
            </Fill>
            <Fill style={{flex: '1 1 75%', display: 'flex', alignItems: 'center'}}>
              <BlockQuote>
                <Quote >I would say like 90% of your day is dictated by technology, and if you, as a person, are not <br />included in that technology, what's the point if your<br /> app is fast?</Quote>
        ...
        <Slide bgColor="secondary">
          ...
          <Link textColor="tertiary" href="https://codepen.io/knittingcodemonkey/pen/yomQBr">Let's look at what we have to do to make a div accessible</Link>
        </Slide>

        <Slide bgImage={images.wheelchair} bgDarken={0.7}>
        <Image src={images.firstRuleOfAria} style={{maxHeight: 852}} />
        </Slide>
          ...
          <Layout>
            ...
            <ul style={{listStyleType: 'none'}}>
              ...
              <li style={[styles.li, { marginTop: 30 }]}>
                <Text textColor="primary" style={styles.liLargeText}>Capability Loss Simulation Tools</Text>
                <ul>
                  <li style={{ lineHeight: '1.6em' }}>
                    <Link textColor="dktertiary" href="http://www.inclusivedesigntoolkit.com/">
                      University of Cambridge: Inclusive Design Toolkit
                    </Link>
                  </li>
                  <li style={{ lineHeight: '1.6em' }}>
                    <Link textColor="dktertiary" href="https://www.toptal.com/designers/colorfilter">
      ...
      >
        ...
        <Slide bgImage={images.mistakes} bgDarken={0.80} textAlign="left">
          ...
          <Fill style={{flex: '1 1 10%', display: 'flex', alignItems: 'center'}}>
              <Image margin="0" src={images.daenerys} style={{
                width: 400, height: 400, borderRadius: '50%', marginRight: 20, marginTop: -40
              }} />
            </Fill>
            <Fill style={{flex: '1 1 90%'}}>
        ...
        <Slide bgImage={images.reactWeek} bgDarken={0.2} notes="So we took those lessons, got a little training, and iterated again.">
          <Heading textColor="primary" size={1} style={{ textShadow: '0px 0px 20px #000', textAlign: 'right' }}>React Week</Heading>
            <Fill>
              <Text textColor="primary" style={{ fontSize: '1.8em', textShadow: '0px 0px 20px #000', fontWeight: 'bold', marginTop: 160, marginLeft: -190 }}>It's me!</Text>
              <Text textColor="primary" style={{ fontSize: '1.0em', textShadow: '0px 0px 20px #000', fontWeight: 'bold', marginTop: 240, marginBottom: 130, marginLeft: '-15px' }}> &uarr; my coffee (very important)</Text>
            </Fill>
        </Slide>
        ...
        <Slide fit bgImage={images.brickBg} bgDarken={0.7} style={{ position: 'relative', height: '100%' }} notes="<ul><li>Nearly all the css-in-js libs use ThemeProvider</li><li>If you're not using a css-in-js lib, you can still use ThemeProvider</li></ul>">
          <Heading textColor="primary" fit caps>It doesn't matter!</Heading>
          <Heading textColor="primary" fit caps>The styles inside and outside are mutually exclusive</Heading>
          <Link textColor="dktertiary" style={{marginTop: 80, display: 'block'}} href="https://github.com/jschr/theme-provider/blob/master/README.md">withTheme/ThemeProvider</Link>
        </Slide>
